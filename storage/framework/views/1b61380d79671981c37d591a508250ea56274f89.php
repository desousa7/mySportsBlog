...
<div class ="sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-15 border-b border-gray-200">
    ...
    <div>
        ...
        <br>
        <a href ="/blog/<?php echo e($post->slug); ?>" class ="uppercase bg-blue-500 text-gray-100 text-lg font-extrabold py-4 px-8 rounded-5xl">
            Keep reading
        </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mySportsBlog\resources\views/blog/index.blade.php ENDPATH**/ ?>